...
const api = {
  ...
  sales: {
    ...
    list: (input: ListSalesInput) => ipcRenderer.invoke(IPC.sales.list, input),
    get: (id: number) => ipcRenderer.invoke(IPC.sales.get, { id }),
    print: (id: number) => ipcRenderer.invoke(IPC.sales.print, { id }),
  },
  receipt: {
